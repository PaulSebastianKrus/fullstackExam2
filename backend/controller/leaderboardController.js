...
import {
  updateLeaderboard as emitLeaderboardUpdate,
  updateUserStats as emitUserStatsUpdate,
} from "../socket.js";
...
export const updateLeaderboard = async (
  ...
  try {
    ...
    if (leaderboardEntry) {
      leaderboardEntry.totalEarnings += moneyWon;
      ...
      const totalQuestions = leaderboardEntry.gamesPlayed * 15;
      leaderboardEntry.averageTimePerQuestion =
        (leaderboardEntry.averageTimePerQuestion * (totalQuestions - 15) +
