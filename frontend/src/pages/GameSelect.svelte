  ...
  $: filteredGames =
    selectedFilter === 'all'
      ...
      : selectedFilter === 'classic'
        ? games.filter((game) => game.isDefault || game.creatorName === 'System')
  ...
  <div class="content-container">
    <div class="filter-controls">
      <div class="filter-buttons">
        <button class="filter-btn" class:active={selectedFilter === 'all'} on:click={() => (selectedFilter = 'all')}>
          <i class="fas fa-th-list"></i> All Games
        </button>

        <button class="filter-btn" class:active={selectedFilter === 'classic'} on:click={() => (selectedFilter = 'classic')}>
          <i class="fas fa-trophy"></i> Classic Games
        </button>

        <button class="filter-btn" class:active={selectedFilter === 'custom'} on:click={() => (selectedFilter = 'custom')}>
          <i class="fas fa-users"></i> Custom Games
        </button>

        <button class="filter-btn" class:active={selectedFilter === 'my-games'} on:click={() => (selectedFilter = 'my-games')}>
